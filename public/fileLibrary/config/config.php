...
$folder_root = $_SESSION['folder_root'];
/*
|--------------------------------------------------------------------------
| Optional security
|--------------------------------------------------------------------------
...
$config = array(
	...
	*/
	...
	'upload_dir' => $folder_root.'images/', //ĐƯỜNG DẨN TỈNH THƯ MỤC UPLOAD - Ở ĐÂY TÔI ĐỂ IMAGES
	...
	|
	*/
	'current_path' => '../images/', //CHỈ ĐẾN ĐÚNG ĐÚNG THƯ MỤC GỐC(TÙY VÀO VỊ TRÍ ĐỂ ỨNG DỤNG NÀY - DÙNG ../ ĐỂ VỀ THƯ MỤC TRƯỚC)
	...
	|
	*/
	'thumbs_base_path' => '../thumbs/', //CHỈ ĐẾN ĐÚNG ĐÚNG THƯ MỤC THUMB(TÙY VÀO VỊ TRÍ ĐỂ ỨNG DỤNG NÀY - DÙNG ../ ĐỂ VỀ THƯ MỤC TRƯỚC)
