...
<html>
    ...
    <body>
        <form action="<?php echo XuLyDangNhap?>" method="POST" class="container">
            <div class="form">
                <h2>Đăng nhập</h2>
                <div class="inputBox">
                ...
                <div class="inputBox">
                    <input name="matkhau" type="password" required="required">
                ...
                <?php } ?>
                <p>Bạn chưa có tài khoản? <a href="<?php echo dangky?>">Đăng ký</a></p>
